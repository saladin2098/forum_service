...
type CategoryServiceClient interface {
	...
	DeleteCategory(ctx context.Context, in *ByName, opts ...grpc.CallOption) (*Void, error)
...
func (c *categoryServiceClient) DeleteCategory(ctx context.Context, in *ByName, opts ...grpc.CallOption) (*Void, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Void)
...
type CategoryServiceServer interface {
	...
	DeleteCategory(context.Context, *ByName) (*Void, error)
...
func (UnimplementedCategoryServiceServer) CreateCategory(context.Context, *Category) (*Category, error) {
...
func (UnimplementedCategoryServiceServer) DeleteCategory(context.Context, *ByName) (*Void, error) {
